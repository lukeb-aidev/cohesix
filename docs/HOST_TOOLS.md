...
integration, install the [version-aligned PyPI distribution](https://pypi.org/project/cohesix/1.1.0b1/)
in an isolated environment with `python3 -m pip install 'cohesix==1.1.0b1'`.
