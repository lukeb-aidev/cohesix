...
rootserver. The current QEMU policy therefore reserves 8 MiB and requires a
9 MiB minimum elfloader archive; replacement and rootfs guards remain separate
and fail closed.
