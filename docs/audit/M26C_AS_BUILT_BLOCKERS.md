...
notification, non-MCS scheduling, and QEMU validation lanes. The final Pi 4
closure uses one coherent wired GENET boot in the freshest non-empty serial log,
...
| Post-behavior baseline freeze | QEMU+PI4-FROZEN | QEMU Stage 01-05 and final Pi GENET Stage 01-05 proof are both recorded; future cleanup remains outside 26c unless separately characterized. |
