...
## 6. GPU Bridge Files (host-mirrored)
...
## 8. PolicyFS & Actions (`/policy`, `/actions`)
| Path | Mode | Description |
|------|------|-------------|
...
## 9. AuditFS & ReplayFS (`/audit`, `/replay`)
| Path | Mode | Description |
|------|------|-------------|
...
## 10. Root Task RPC (internal trait)
```rust
