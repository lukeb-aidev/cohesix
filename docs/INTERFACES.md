...
- Status snapshots are rate-limited by `swarmui.hive.status_poll_ms` and cached between polls; telemetry deltas remain real-time within the configured event budget.
