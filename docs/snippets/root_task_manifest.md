...
- `hw.network.mode`: `dhcp`
- `hw.network.interface`: `auto`
...
- `hw.devices[]`: `kind=keyboard` `id=usb-kbd0` `required=true`
- `hw.devices[]`: `kind=display` `id=hdmi0` `required=true`
