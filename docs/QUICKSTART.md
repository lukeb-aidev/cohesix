...
macOS and Jetson users: SMP may require software emulation. If the VM hangs, run with
`COHESIX_QEMU_ACCEL=tcg COHESIX_QEMU_MACHINE_EXTRA=kernel-irqchip=off COHESIX_QEMU_VIRT=on`.
