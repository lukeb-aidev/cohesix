...
direct-GENET child uses 66 image pages and allocates no new direct data-plane
frames: it maps 32 exact external copies of GENET-owned CPU pages, for 104
frames and 161 retained root slots. The Pi-only increase is one immutable
executable image frame and its retained mapping cap. Both retain eight anchor-derived
...
- `configs/root_task_pi4_uboot_aarch64.toml` — `sha256:4b56183adc8a77fa94e6c5dc960f9f0c48eb9b97654940ae4bfbf1623ce4a955`
- Pi `pi4_production` transient resolved binding — `sha256:1f0aa22c10c021428c4173673caa316bffcce70aaf89470c11301f2157560232`
