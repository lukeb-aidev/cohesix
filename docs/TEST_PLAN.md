...
failure, and result records must enqueue without a raw/current-TCB UART write;
tests must show the linked flush waits for the following operator turn and does
not share a turn with a CYW43 operation. During
