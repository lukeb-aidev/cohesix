...
archive. All seven generated runtime specs remain acceptance-eligible. The Pi
GENET speed build has a 407-page measured span inside its 416-page code aperture;
the other six linked runtimes retain 320-page apertures. The builder must verify
that its GENET-only Cargo invocation leaves every other child binary unchanged.
Current Pi proof requires
...
`p_filesz <= p_memsz`, the selected generated per-image aperture, exact packaged runtime
...
- `configs/root_task_pi4_uboot_aarch64.toml` — `sha256:fa158dbf0246a46d3538acd51c8143ac4fc6deadbfb3d5bdf84e811d4e0f8da1`
- Pi `pi4_production` transient resolved binding — `sha256:b6d920a124b3848d03f290d62ac58bf337eb3872686ff9b4e450d03aa6dd7d6d`
