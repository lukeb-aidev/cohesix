...
`m26e-qemu-root-turn-candidate-v2` provenance. They must also assert the derived
...
stack/temporal contract, not acceptable containment evidence.
...
- `configs/generated/root_task_resolved.json` — `sha256:50b51eb4e5d6f91bc0f0ecefb9974c6566328e857cd92bc2542eb06fae159016`
