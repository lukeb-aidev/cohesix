...
- CYW43 linked-runtime transport status labels are fail-closed: partial transport details are reported as `progress`, and only `DRIVER_RUNTIME_CYW43_TRANSPORT_DETAIL_READY` is reported as `ready`.
