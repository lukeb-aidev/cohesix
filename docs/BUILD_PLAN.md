...
Commands:
  ...
  - python3 scripts/pi4_trace_normalize.py pi4-serial.log --gate-summary --expect USB_GATE=3 --expect USB_BLOCKER=cmd-poll-only-timeout --expect WIFI_GATE=4 --expect WIFI_BLOCKER=ht-clock-timeout
