...
Inputs: apps/root-task/src/local_seat_pi4.rs, apps/pi4-driver-runtime/src/lib.rs, crates/pi4-driver-abi/src/lib.rs, crates/cohesix-usb/src/{xhci.rs,hid.rs,ram.rs}, apps/root-task/src/event/*, scripts/pi4_trace_normalize.py, tests/test_pi4_trace_normalize.py, docs/DRIVERS.md.
Changes:
