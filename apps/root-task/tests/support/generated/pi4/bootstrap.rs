...
pub const AUDIT_TABLE_SHA256: &str =
    "f857683fddeab48de4f7c92363bfd85d30db358b33599f9f8351729ae07fc196";
...
pub const DMA_CONFIG: DmaConfig = DmaConfig {
    protection_profile: DmaProtectionProfile::BoundedNoIommu,
};
...
pub const WORKER_RUNTIME_CONFIG: WorkerRuntimeConfig = WorkerRuntimeConfig {
    ...
    scheduling: WorkerSchedulingConfig {
        profile: WorkerSchedulingProfile::McsPassive,
        priority: 96,
        domain: 0,
...
pub const TEMPORAL_TASKS: [TemporalTaskConfig; 272] = [
    TemporalTaskConfig {
        id: "root-control",
        ...
        admitted: true,
        wcet_provenance: "m26e-pi4-root-cross-core-causal-fanin-wait-candidate-v27",
    ...
    TemporalTaskConfig {
        ...
        admitted: true,
        wcet_provenance: "m26e-qemu-root-fault-service-units-candidate-v6",
        virtio_operator_serial_io_bytes_per_turn: 0,
        allowed_donors: &[],
        reply_objects: 0,
        max_donation_depth: 0,
    ...
    TemporalTaskConfig {
        id: "root-worker-executor-gpu",
        kind: TemporalTaskKind::WorkerExecutor,
        execution: TemporalExecution::Active,
        core: 2,
        ...
        admitted: true,
        wcet_provenance: "m26e-passive-worker-executor-gpu-v1",
        virtio_operator_serial_io_bytes_per_turn: 0,
        allowed_donors: &[],
        reply_objects: 0,
        max_donation_depth: 0,
    ...
    TemporalTaskConfig {
        ...
        admitted: true,
        wcet_provenance: "m26e-passive-worker-executor-lora-v1",
        virtio_operator_serial_io_bytes_per_turn: 0,
        allowed_donors: &[],
        reply_objects: 0,
        max_donation_depth: 0,
    ...
    TemporalTaskConfig {
        ...
        admitted: true,
        wcet_provenance: "m26e-pi4-console-cross-core-causal-publication-candidate-v21",
        virtio_operator_serial_io_bytes_per_turn: 0,
        allowed_donors: &[],
        reply_objects: 0,
        max_donation_depth: 0,
    ...
    TemporalTaskConfig {
        id: "driver-serial",
        kind: TemporalTaskKind::Driver,
        execution: TemporalExecution::Active,
        core: 1,
        scheduling_context_slot: 10,
        scheduling_context_bits: 9,
        sched_control_core: 1,
        budget_us: 500,
        period_us: 10000,
        deadline_us: 10000,
    ...
    TemporalTaskConfig {
        ...
        priority: 96,
        mcp: 220,
        timeout_badge: 653131788,
        timeout_policy: TimeoutPolicy::NaturalPostpone,
        consumed_time_evidence: true,
        wcet_us: 1800,
        response_time_us: 5200,
        admitted: true,
        wcet_provenance: "m26e-pi4-hdmi-write-only-candidate-v1",
        virtio_operator_serial_io_bytes_per_turn: 0,
        allowed_donors: &[],
        reply_objects: 0,
        max_donation_depth: 0,
    ...
    TemporalTaskConfig {
        ...
        priority: 112,
        mcp: 220,
        timeout_badge: 653131792,
        timeout_policy: TimeoutPolicy::Terminal,
        consumed_time_evidence: true,
        wcet_us: 300,
        response_time_us: 3300,
        admitted: true,
        wcet_provenance: "m26e-qemu-candidate-v1",
        virtio_operator_serial_io_bytes_per_turn: 0,
        allowed_donors: &[],
    ...
    TemporalTaskConfig {
        ...
        priority: 96,
        mcp: 128,
        timeout_badge: 653131793,
        timeout_policy: TimeoutPolicy::ReturnError,
        consumed_time_evidence: false,
        wcet_us: 0,
        response_time_us: 0,
        admitted: false,
        wcet_provenance: "m26e-passive-worker-executor-v1",
        virtio_operator_serial_io_bytes_per_turn: 0,
        allowed_donors: &["root-worker-executor-lora"],
        reply_objects: 1,
        max_donation_depth: 1,
        fault_handler: "root-fault",
        critical_reserve: false,
...
pub const EXECUTABLE_ROLE_ADMISSION: [ExecutableRoleAdmission; 3] = [
    ExecutableRoleAdmission {
        ...
        namespace_capacity: 256,
        executable_slots: 1,
        core: 3,
        revoke_anchor_slot: 15000,
...
pub const EXECUTABLE_ROLE_MIXES: [ExecutableRoleMix; 1] = [ExecutableRoleMix {
    id: "maximum-multi-worker-mix",
    maximum: true,
    roles: &EXECUTABLE_ROLE_MIX_0,
}];

pub const CRITICAL_TCB_RESOURCES: [CriticalTcbResource; 7] = [
    CriticalTcbResource {
        id: "root-control",
        cnode_radix_bits: 7,
        cspace_cap_count: 32,
...
pub const WORKER_RESOURCE_ADMISSION_CONFIG: WorkerResourceAdmissionConfig =
    WorkerResourceAdmissionConfig {
        ...
        capacity: KernelObjectBudget {
            ...
            notifications: 128,
            fault_caps: 512,
            timeout_fault_caps: 512,
            reply_objects: 512,
            scheduling_contexts: 512,
            cspace_slots: 65536,
        ...
        fixed_objects: KernelObjectBudget {
            ...
            notifications: 34,
            fault_caps: 16,
            timeout_fault_caps: 16,
            reply_objects: 15,
            scheduling_contexts: 16,
            cspace_slots: 9277,
            untyped_bytes: 100663296,
        },
        ...
        handoff: CriticalHandoffConfig {
            worker_control_queue_capacity: 256,
            worker_fault_mailboxes: 256,
            driver_fault_records: 7,
            worker_wake_badge: 1,
            driver_wake_badge: 2,
        ...
        fault_registry: FaultRegistryAdmission {
            ...
            driver_tcbs: 7,
            capacity: 272,
            root_fault_tcb_control_slot_base: 267,
            receive_endpoints: 1,
...
pub const DRIVER_RUNTIME_IRQS: [DriverRuntimeIrqSpec; 5] = [
...
pub const HARDWARE_CONFIG: HardwareConfig = HardwareConfig {
    ...
    attestation: AttestationConfig {
        mode: AttestationMode::MeasurementOnly,
        required: false,
...
pub const INITIAL_AUDIT_LINES: [&str; 57] = [
    ...
    "manifest.sha256=cee12a7d867a8ea6b7e236387f0363fab20a0b12c79bd1f35c6c2416506a37f0",
    "manifest.tickets=5",
    ...
    "manifest.dma.protection_profile=bounded-no-iommu",
    ...
    "manifest.worker_runtime.task_abi.version=2 shared_page_bytes=4096 ready_timeout_ms=5000 shutdown_grace_ms=1000 max_control_inflight=1",
    "manifest.worker_runtime.scheduling.profile=mcs-passive",
    ...
    "manifest.temporal_authority.tasks=272",
    "manifest.worker_resource_admission.enabled=true",
    "manifest.worker_resource_admission.executable_slots=256",
    "manifest.worker_resource_admission.fault_registry.capacity=272",
    ...
    "manifest.hw.network.dhcp.discover_timeout_ms=1500",
    "manifest.hw.network.dhcp.request_timeout_ms=1500",
    "manifest.hw.network.dhcp.max_retries=6",
    "manifest.hw.attestation.required=false",
    "manifest.hw.attestation.mode=measurement_only",
    ...
    "measurement.bound_manifest_sha256=cee12a7d867a8ea6b7e236387f0363fab20a0b12c79bd1f35c6c2416506a37f0",
