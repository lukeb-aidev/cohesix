...
fn word_bits_as_u8() -> u8 {
    u8::try_from(sel4::WORD_BITS)
        .expect("WORD_BITS must fit within u8 for seL4 CNode syscalls")
}
...
pub mod canonical {
    ...
    use super::{debug_log, encode_cptr_index, sel4, sys, word_bits_as_u8, RootPath, CANONICAL_CNODE_INDEX};
