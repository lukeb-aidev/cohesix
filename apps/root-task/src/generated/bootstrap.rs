...
pub const AUDIT_TABLE_SHA256: &str =
    "15b553f57f27a57b283adb1f9d722822755c3abca99e532e6415c61ed2a521f6";
...
pub const TEMPORAL_TASKS: [TemporalTaskConfig; 44] = [
    TemporalTaskConfig {
        id: "root-control",
        ...
        wcet_us: 5000,
        response_time_us: 7600,
        admitted: true,
        wcet_provenance: "m26e-qemu-root-adjacent-refill-natural-postpone-candidate-v35",
    ...
    TemporalTaskConfig {
        ...
        response_time_us: 7500,
        admitted: true,
        wcet_provenance: "m26e-qemu-multi-worker-v1",
        virtio_operator_serial_io_bytes_per_turn: 0,
        allowed_donors: &[],
        reply_objects: 0,
        max_donation_depth: 0,
...
pub const WORKER_RESOURCE_ADMISSION_CONFIG: WorkerResourceAdmissionConfig =
    WorkerResourceAdmissionConfig {
        ...
        handoff: CriticalHandoffConfig {
            worker_control_queue_capacity: 64,
            worker_fault_mailboxes: 37,
...
pub const INITIAL_AUDIT_LINES: [&str; 49] = [
    ...
    "manifest.temporal_authority.tasks=44",
    "manifest.worker_resource_admission.enabled=true",
    "manifest.worker_resource_admission.executable_slots=37",
    "manifest.worker_resource_admission.fault_registry.capacity=44",
