...
fn cyw43_wait_for_host_eapol(
    ...
    for poll in 0..CYW43_HOST_EAPOL_JOIN_POLLS {
        if let Some((_flags, token)) = poll_cyw43_driver_task_data_frame() {
    ...
    Err(DriverTaskNetError::RuntimeInit("host-eapol-required"))
}
