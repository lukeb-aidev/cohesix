...
| --- | --- |
| [`secure9p-codec`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/crates/secure9p-codec) | `no_std + alloc` wire types, four-byte 9P length framing, request/response encoding, decoding, batch iteration, and codec fuzz entry points. |
| [`secure9p-core`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/crates/secure9p-core) | `no_std + alloc` tag windows, queue limits, active/retired fid tables, append-only offset helpers, short-write policy, and an access-policy trait. It is not a complete server dispatcher. |
| [`secure9p-transport`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/crates/secure9p-transport) | A `no_std` crate boundary only. It does not currently implement in-process, seL4-endpoint, or TCP adapters. |
| [Host NineDoor](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/nine-door/src/host) | The complete host-side session state machine, ticket verification, role policy, provider dispatch, batching, metrics, and error mapping. |
| [Target `NineDoorBridge`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/root-task/src/ninedoor.rs) | A separate `no_std` namespace/control adapter reached through the console event pump. It does not decode Secure9P frames. |
...
[the generated manifest snippet](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/snippets/root_task_manifest.md).
...
[`secure9p-core/src/session.rs`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/crates/secure9p-core/src/session.rs) and
applied by host NineDoor's
[`ServerCore`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/nine-door/src/host/core.rs).
...
[observability_interfaces.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/snippets/observability_interfaces.md).

Secure9P does not imply DMA-backed namespace storage. Device DMA and cache
maintenance are physical-driver concerns governed by [DRIVERS.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/DRIVERS.md).
...
- [`secure9p-codec` tests](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/crates/secure9p-codec)
- [`secure9p-core` tests](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/crates/secure9p-core)
- [NineDoor integration tests](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/nine-door/tests)
- [root-task namespace bridge tests](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/root-task/src/ninedoor.rs)
- [the staged Test Plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TEST_PLAN.md)
