...
<div align="center">
  <div style="width: 720px; max-width: 100%;">
    <img
      src="https://raw.githubusercontent.com/lukeb-aidev/cohesix/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/COHESIX_LOGO.png"
      alt="Cohesix"
      width="720"
    />
  </div>
...
Start with [llms.txt](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/llms.txt) for task selection and authoritative references.
Operational skills cover [Queen inspection](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/skills/cohesix-inspect/SKILL.md),
[governed GPU operations](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/skills/cohesix-gpu-operations/SKILL.md) and
[evidence review](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/skills/cohesix-evidence/SKILL.md), including Python workflows.
...
[AGENTS.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/AGENTS.md) remains the separate contributor charter.
...
![SwarmUI showing a verified historical LoRA run with distinct evidence owners and a persistent REPLAY label](https://raw.githubusercontent.com/lukeb-aidev/cohesix/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/images/swarmui/run-story.jpg)
...
Linux ARM64 host bundles. See the [release notes](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/releases/RELEASE_NOTES-1.0.0-beta.md)
...
[audit report](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/audit/AUDIT_REPORT_2026-09-13.md) for the accepted gaps and
...
and the [Build Plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md) for the complete record of planned and
...
Choose the matching **1.0.0-beta** Mac or Linux ARM64 archive under [releases/](https://github.com/lukeb-aidev/cohesix/tree/8d8784a1d72c47b20244b33b5c6a2459be40c245/releases)
...
[prepare the external seL4 16.0.0 project](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TOOLCHAIN_MAC_ARM64.md#2-prepare-the-external-sel4-project-source),
then [configure, build, and validate](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TOOLCHAIN_MAC_ARM64.md#6-rebuilding-sel4-profiles)
...
| [Boot reference](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BOOT_REFERENCE.md) | Interpret boot stages, prompts, and fail-closed markers |
| [Benchmarks](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BENCHMARKS.md) | Run and interpret reproducible performance measurements |
| [Failure modes](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/FAILURE_MODES.md) | Diagnose and recover from observable failures |
...
| Document | Use it to |
| --- | --- |
| [Toolchain setup](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TOOLCHAIN_MAC_ARM64.md) | Reproduce the pinned macOS build environment and external seL4 contract |
| [Drivers](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/DRIVERS.md) | Design, implement, test, and qualify a physical driver |
| [Contributing](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/CONTRIBUTING.md) | Propose, implement, validate, and submit a scoped change |
| [API guidelines](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/API_GUIDELINES.md) | Implement against the REST projection and compatibility rules |
...
| [Build plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md) | Read the normative record of planned and implemented project scope |
- Contributions must follow [`AGENTS.md`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/AGENTS.md),
  [Contributing](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/CONTRIBUTING.md), and align to the active task in the
  [build plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md).
...
- New to Cohesix? Read [current status](docs/STATUS.md), use the
  ...
  [failure modes](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/FAILURE_MODES.md) for diagnosis and recovery.
...
[NOTICE.txt](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/NOTICE.txt).
