...
Cohesix is a seL4-based control-plane operating system for edge GPU nodes.
A Queen admits and supervises bounded Worker tasks; host executors perform
GPU and ecosystem operations through explicit, ticketed interfaces. Physical
drivers run in isolated target runtimes, and the authenticated console is the
only target TCP listener.
...
[DRIVERS.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/DRIVERS.md).
...
[the generated manifest snippet](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/snippets/root_task_manifest.md); a target build
...
[BUILD_PLAN.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md). Boot-by-boot results are non-canonical evidence;
...
suspended, W^X, least-authority passive child. Two active executor lanes own
the generated Worker-core budgets: the GPU lane serves only GPU instances; the
LoRA lane serves LoRA and Heartbeat. A fixed fair queue selects one exact
instance, donates the lane SC through a depth-one endpoint `Call`, and regains
it only through that instance's generation-scoped Reply object. A successful
...
[Boot Reference](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BOOT_REFERENCE.md) and
...
the instance Reply state exactly once, returns any donated executor SC, clears
records and signals, unmaps private memory, revokes capabilities, and excludes
the old generation before reuse.
...
Console-network ABI v6 derives its direct-GENET extension only for the exact Pi
...
### 6.5 Operator observations and retained evidence
...
remain model/session-only. See [FIELD_BUS.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/FIELD_BUS.md).
...
- Scope and milestones: [BUILD_PLAN.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md)
- Default generated profile summary:
  [snippets/root_task_manifest.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/snippets/root_task_manifest.md)
- Kernel profile contracts:
  [`configs/sel4/profiles.toml`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/configs/sel4/profiles.toml)
- Manifest inputs: [`configs/root_task.toml`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/configs/root_task.toml) and
  [`configs/root_task_pi4_uboot_aarch64.toml`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/configs/root_task_pi4_uboot_aarch64.toml)
- Root task: [`apps/root-task`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/root-task)
- Host NineDoor: [`apps/nine-door`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/nine-door)
- Physical-driver runtime:
  [`apps/pi4-driver-runtime`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/pi4-driver-runtime)
- Driver ABI: [`crates/pi4-driver-abi`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/crates/pi4-driver-abi)
- Host-tool boundary: [HOST_TOOLS.md](HOST_TOOLS.md)
- GPU boundary: [GPU_NODES.md](GPU_NODES.md)
- Role and scheduling contract:
  [ROLES_AND_SCHEDULING.md](ROLES_AND_SCHEDULING.md)
- Manifest compiler: [`tools/coh-rtc`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/tools/coh-rtc)
- Validation and acceptance: [TEST_PLAN.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TEST_PLAN.md)
