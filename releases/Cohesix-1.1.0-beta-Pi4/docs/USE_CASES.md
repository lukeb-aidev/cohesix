...
[`configs/generated/host_integration_dependency.json`](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/configs/generated/host_integration_dependency.json).
The generated [support table](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/snippets/host_integration_dependency.md) names the
...
[27b–27d](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md#27b); optional Apple-GPU and broader domain workflows
belong to [28a](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md#28a).
...
| --- | --- | --- |
| Replace generic playbook endings with generated `preflight → admit → execute → observe → verify → recover` stages. | Makes a playbook a real workflow rather than a persuasive name around control writes. | `m27c-recipe-lifecycle-and-identity` for the selected recipe; `m28a-live-reference-workflows` in [28a](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md#28a) for all domain playbooks |
| Prove the portable Linux AArch64 NVIDIA path on Jetson, with explicit CUDA/NVML versions and bounded real workloads. | Gives Cohesix one compelling, reproducible edge-AI reference instead of a mock GPU story. | `m27b-jetson-orin-nano-live-conformance` in [Milestone 27b](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md#27b) |
| Make host and Worker receipts authoritative and causally linked. | Lets operators reconstruct whether a request was admitted, executed, observed, and verified. | `m27b-authoritative-receipt-and-evidence-core` in [Milestone 27b](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md#27b) |
| Complete native import/training, comparable evaluation and verified serving rollback. | Makes a genuine adapter release usable and safe to recover. | [Milestone 27d](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md#27d) |
| Package the accepted recipes and reconcile CI retries. | Lets newcomers use CLI/Python without hidden setup or duplicated work. | [Milestone 27e](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md#27e) |
| Build the visual Live AI Hive journey in SwarmUI. | Makes capability boundaries, provider truth, failures, and evidence understandable to newcomers. | `m27f-live-ai-community-showcase` in [Milestone 27f](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md#27f) |
| Add focused provider fixtures, negative tests, and documentation. | Gives seL4, Rust, Python, GPU, and operations contributors useful pieces that can be reviewed independently. | [Test Plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TEST_PLAN.md) and the active owning task |
...
promotes itself. Start with [Contributing](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/CONTRIBUTING.md), reproduce the
...
[TEST_PLAN.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TEST_PLAN.md) for the required validation lane,
[BENCHMARKS.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BENCHMARKS.md) for performance claims, and
