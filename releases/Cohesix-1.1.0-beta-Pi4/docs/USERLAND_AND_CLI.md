...
[Failure modes](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/FAILURE_MODES.md), rather than repeatedly issuing them.
...
or release claims use the staged, provenance-bound [Test plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TEST_PLAN.md).
...
such as [boot_v0.coh](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/scripts/cohsh/boot_v0.coh), must be regenerated rather
...
| `pool bench <options>` | Mutating host session-pool benchmark; use the [benchmark workflow](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BENCHMARKS.md), not as a first health check |

Durable CUDA recipe composition is available through the external `coh`
plan/apply/watch/explain/verify/recover commands with `--recipe`; see
[Recoverable CUDA recipes](HOST_TOOLS.md#recoverable-cuda-recipes). The shared
cohsh/SwarmUI manuals explain this host-only boundary. These options do not
change root-console or `.coh` grammar.
...
not zero-valued proof. Detailed driver contracts are in [DRIVERS.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/DRIVERS.md),
external schemas in [INTERFACES.md](INTERFACES.md), and acceptance requirements
in [TEST_PLAN.md](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TEST_PLAN.md).
...
[the recorder implementation](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/root-task/src/pi4_mcs_recorder.rs).
...
[SwarmUI](SWARMUI.md) connects to a Queen or Hive Gateway through an editable
connection dialog. Namespace actions, validated control forms, installed host
operations, canonical evidence and offline replay do not require console grammar.
The optional expert console retains `man`, raw JSON spawn compatibility and
transport-supported root diagnostics. Review and confirmation do not replace
target admission, and an ACK does not imply execution. The host operation schema
is shared with `coh`; credentials stay out of profiles and previews.
...
- `policy.sha256`: `90fb015f6a0684b04bd116f77968e10ce071f398296630007b583613c941c9ad`
...
_Generated from `configs/root_task.toml` (sha256: `d3029e105edb84e05b1377a6a479ae4e1e3bed555046e4606625644c95951aa5`)._
...
- `manifest.sha256`: `d3029e105edb84e05b1377a6a479ae4e1e3bed555046e4606625644c95951aa5`
- `policy.sha256`: `9175d150bc1fe42af27ca6208e902626c31df88832f3d9c18198f51004acba4c`
...
- `manifest.sha256`: `d3029e105edb84e05b1377a6a479ae4e1e3bed555046e4606625644c95951aa5`
- `swarmui.defaults.sha256`: `afb30700a7bf286776c10e0b5636f88a031a296068751d00b3ad7f98ef0852c3`
...
| --- | --- |
| Host options, environment resolution, script/trace startup | [cohsh main](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/cohsh/src/main.rs) |
| Actual host dispatcher, payload builders, scripts, self-tests and local file export | [cohsh core](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/cohsh/src/lib.rs) |
| Shared target parser and bounds | [cohsh-core command parser](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/crates/cohsh-core/src/command.rs) |
| TCP connection, acknowledgement and close handling | [TCP transport](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/cohsh/src/transport/tcp.rs) |
| Gateway projection and caller binding | [REST transport](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/cohsh/src/transport/rest.rs), [API guidelines](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/API_GUIDELINES.md) |
| Worker role/path projection and independent state axes | [Worker helpers](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/apps/cohsh/src/worker.rs) |
| Installed test content | [resources/proc_tests](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/resources/proc_tests) |
...
| Image-qualified release and performance checks | [Test plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TEST_PLAN.md), [Benchmarks](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BENCHMARKS.md) |
