...
The [Build Plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md) remains the complete record of authorized and
implemented scope, while target-qualified evidence and acceptance procedures
remain governed by the [Test Plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TEST_PLAN.md).
...
Release A (`1.1.0-beta`) completes [Milestone 27g](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md#27g).
...
AArch64 NVIDIA operator run. The applicable staged [Test Plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TEST_PLAN.md)
...
[qualification record](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/audit/M27G_IMPLEMENTATION_RECORD.md) identifies each
...
| --- | --- | --- |
| Admitted native CUDA execution and recoverable recipes | [GPU nodes](GPU_NODES.md) | [Host foundation](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/audit/M27B_IMPLEMENTATION_RECORD.md), [recovery and reuse](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/audit/M27C_IMPLEMENTATION_RECORD.md) |
| Private LoRA import/training, evaluation, promotion and rollback | [Private LoRA release](PRIVATE_LORA_RELEASE.md) | [Native execution and recovery](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/audit/M27D_IMPLEMENTATION_RECORD.md) |
| Signed package installation, Python and CI | [Adoption](ADOPTION.md), [CI workflows](CI_WORKFLOWS.md) | [Package and installation checks](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/audit/M27E_IMPLEMENTATION_RECORD.md) |
| Native desktop operations, evidence and signed replay | [SwarmUI](SWARMUI.md), [gallery](SWARMUI_GALLERY.md) | [Native app and packaged checks](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/audit/M27F_IMPLEMENTATION_RECORD.md) |
| Delegated authority, failover, inspection and evidence | [Authority](M27A_AUTHORITY.md), [operator evidence](OPERATOR_EVIDENCE.md) | [Authority qualification](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/audit/M27A_COMPLETION_EVIDENCE.md), [operator utilities](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/audit/M27_COMPLETION_EVIDENCE.md) |
...
scope. The previous [1.0.0-beta](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/releases/RELEASE_NOTES-1.0.0-beta.md)
acceptance and provenance exceptions remain in the
[audit record](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/audit/AUDIT_REPORT_2026-09-13.md). The current
[exceptions register](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/audit/EXCEPTIONS.md) records DD30 as an owner-accepted
...
by the [Build Plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md#roadmap-id-mapping). Their existing source or
...
| QEMU | `aarch64/virt` with GICv3 is the reference target on macOS HVF and AArch64 Linux KVM. | Target-qualified evidence applies only to the exact VM artifacts and proof lanes exercised; see the [Milestone 26e result record](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BUILD_PLAN.md#26e). It is not Pi 4 hardware proof. |
...
- For QEMU or Pi acceptance, use the exact staged workflow in the
  [Test Plan](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/TEST_PLAN.md).
- For build, flash, readback, boot, network, and console proof, follow
  [Hardware Bring-up](HARDWARE_BRINGUP.md).
- For performance claims, follow [Benchmarking](https://github.com/lukeb-aidev/cohesix/blob/8d8784a1d72c47b20244b33b5c6a2459be40c245/docs/BENCHMARKS.md) and retain the
