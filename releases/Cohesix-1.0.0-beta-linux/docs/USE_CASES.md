...
The generated [support table](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/snippets/host_integration_dependency.md) names the
...
[Status](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/STATUS.md) for the current evidence boundary and the
[Glossary](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/GLOSSARY.md) for Cohesix-specific terms.
...
| --- | --- | --- |
| Replace generic playbook endings with generated `preflight → admit → execute → observe → verify → recover` stages. | Makes a playbook a real workflow rather than a persuasive name around control writes. | `m27b-live-reference-workflows` in [Milestone 27b](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/BUILD_PLAN.md#27b) |
| Prove the portable Linux AArch64 NVIDIA path on Jetson, with explicit CUDA/NVML versions and bounded real workloads. | Gives Cohesix one compelling, reproducible edge-AI reference instead of a mock GPU story. | `m27b-jetson-orin-nano-live-conformance` in [Milestone 27b](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/BUILD_PLAN.md#27b) |
| Make host and Worker receipts authoritative and causally linked. | Lets operators reconstruct whether a request was admitted, executed, observed, and verified. | `m27b-authoritative-receipt-and-evidence-core` in [Milestone 27b](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/BUILD_PLAN.md#27b) |
| Build the visual Live AI Hive journey in SwarmUI. | Makes capability boundaries, provider truth, failures, and evidence understandable to newcomers. | `m27f-live-ai-community-showcase` in [Milestone 27f](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/BUILD_PLAN.md#27f) |
| Add focused provider fixtures, negative tests, and documentation. | Gives seL4, Rust, Python, GPU, and operations contributors useful pieces that can be reviewed independently. | [Test Plan](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/TEST_PLAN.md) and the active owning task |
...
promotes itself. Start with [Contributing](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/CONTRIBUTING.md), reproduce the
[Quickstart](../QUICKSTART.md), and use [Operator Recipes](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/OPERATOR_RECIPES.md) to
...
[Operator Walkthrough](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/OPERATOR_WALKTHROUGH.md). Use
[TEST_PLAN.md](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/TEST_PLAN.md) for the required validation lane,
[BENCHMARKS.md](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/BENCHMARKS.md) for performance claims, and
