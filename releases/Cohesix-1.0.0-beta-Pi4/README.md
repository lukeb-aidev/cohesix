...
<div align="center">
  <div style="width: 720px; max-width: 100%;">
    <img
      src="https://raw.githubusercontent.com/lukeb-aidev/cohesix/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/COHESIX_LOGO.png"
      alt="Cohesix"
      width="720"
    />
  </div>
...
![SwarmUI replay showing Live Hive telemetry](https://raw.githubusercontent.com/lukeb-aidev/cohesix/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/swarmui-replay.png)
...
Linux ARM64 host bundles. See the [release notes](RELEASE_NOTES.md)
...
[audit report](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/audit/AUDIT_REPORT_2026-09-13.md) for the accepted gaps and
...
See [Current status](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/STATUS.md) for the capability and evidence snapshot,
and the [Build Plan](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/BUILD_PLAN.md) for the complete record of planned and
...
Choose the matching **1.0.0-beta** Mac or Linux ARM64 archive under [releases/](https://github.com/lukeb-aidev/cohesix/tree/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/releases)
...
[prepare the external seL4 16.0.0 project](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/TOOLCHAIN_MAC_ARM64.md#2-prepare-the-external-sel4-project-source),
then [configure, build, and validate](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/TOOLCHAIN_MAC_ARM64.md#6-rebuilding-sel4-profiles)
...
Choose a document by what you want to do. The [Glossary](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/GLOSSARY.md)
...
| Document | Use it to |
| --- | --- |
| [Current status](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/STATUS.md) | Distinguish checked-in capability from QEMU, Pi, release, and use-case acceptance |
...
| [Operator walkthrough](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/OPERATOR_WALKTHROUGH.md) | Complete one end-to-end live workflow |
| [Operator recipes](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/OPERATOR_RECIPES.md) | Perform advanced evidence, mount, lifecycle, ticket, federation, and PEFT tasks |
| [Failure modes](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/FAILURE_MODES.md) | Diagnose and recover from observable failures |
...
| [Boot reference](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/BOOT_REFERENCE.md) | Interpret boot stages, prompts, and fail-closed markers |
| [Benchmarks](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/BENCHMARKS.md) | Run and interpret reproducible performance measurements |

### Develop and contribute

| Document | Use it to |
| --- | --- |
| [Toolchain setup](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/TOOLCHAIN_MAC_ARM64.md) | Reproduce the pinned macOS build environment and external seL4 contract |
| [Drivers](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/DRIVERS.md) | Design, implement, test, and qualify a physical driver |
| [Contributing](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/CONTRIBUTING.md) | Propose, implement, validate, and submit a scoped change |
| [API guidelines](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/API_GUIDELINES.md) | Implement against the REST projection and compatibility rules |
...
| [Build plan](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/BUILD_PLAN.md) | Read the normative record of planned and implemented project scope |
- Contributions must follow [`AGENTS.md`](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/AGENTS.md),
  [Contributing](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/CONTRIBUTING.md), and align to the active task in the
  [build plan](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/BUILD_PLAN.md).

## Help

- New to Cohesix? Read [current status](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/STATUS.md), use the
  [glossary](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/GLOSSARY.md) as terms arise, then follow the
  ...
  [failure modes](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/docs/FAILURE_MODES.md) for diagnosis and recovery.
...
[NOTICE.txt](https://github.com/lukeb-aidev/cohesix/blob/18062f7b4ff0d719e1a6d3f0badb0bebdbeec45d/NOTICE.txt).
