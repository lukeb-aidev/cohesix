# Author: Lukas Bower
# Purpose: Provide shared backend and auth resolution helpers for Cohesix Python examples.
...
def add_backend_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--rest",
        default=None,
        help="hive-gateway base URL (uses RestBackend, e.g. http://127.0.0.1:8080)",
    )
    parser.add_argument(
        "--auth-token",
        default=None,
