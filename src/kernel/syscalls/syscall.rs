...
#[no_mangle]
pub extern "C" fn syscall_trap(syscall_id: usize, a0: usize, a1: usize, a2: usize, a3: usize) -> i64 {
    println!("Trap: syscall from user returned to kernel, syscall_num={}", syscall_id);
...
pub unsafe fn init_syscall_trap() {
    #[cfg(target_arch = "aarch64")]
    {
        extern "C" { static syscall_vector: u8; }
