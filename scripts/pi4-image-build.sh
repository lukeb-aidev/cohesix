...
verify_boot_cmd_handoff() {
    ...
    grep -q 'cohesix,xhci-handoff-source' "$path" || fail "boot.cmd is missing xHCI handoff source DT diagnostics"
    ...
    grep -q 'cohesix,xhci-dcbaap' "$path" || fail "boot.cmd is missing xHCI DCBAAP DT handoff"
    grep -q 'cohesix,xhci-crcr' "$path" || fail "boot.cmd is missing xHCI CRCR DT handoff"
    grep -q 'cohesix,xhci-erstba0' "$path" || fail "boot.cmd is missing xHCI ERSTBA0 DT handoff"
    grep -q 'cohesix,xhci-erdp0' "$path" || fail "boot.cmd is missing xHCI ERDP0 DT handoff"
    grep -q 'cohesix,xhci-erstsz0' "$path" || fail "boot.cmd is missing xHCI ERSTSZ0 DT handoff"
    grep -q 'cohesix,xhci-cap-length' "$path" || fail "boot.cmd is missing xHCI capability snapshot DT handoff"
    grep -q 'cohesix,xhci-hci-version' "$path" || fail "boot.cmd is missing xHCI version DT handoff"
...
setenv coh_force_xhci_handoff_reprobe 'setenv stdin serial; setenv coh_usb_input_ready 0; setenv coh_xhci_handoff_capture_mode reprobe; setenv coh_xhci_reprobe_result failed; echo "[cohesix] forcing USB reprobe before handoff capture"; pci enum; if usb reset; then setenv coh_usb_input_ready 1; setenv coh_xhci_reprobe_result success; echo "[cohesix] USB host reprobe command completed"; else echo "[cohesix] WARNING: usb reset failed before handoff capture"; fi; if env exists coh_xhci_handoff_ready; then setenv coh_xhci_handoff_ready_active ${coh_xhci_handoff_ready}; echo "[cohesix] xhci-handoff-ready active=${coh_xhci_handoff_ready}"; else setenv coh_xhci_handoff_ready_active absent; echo "[cohesix] xhci-handoff-ready active=absent"; fi; if env exists coh_xhci_irq_quiesced; then setenv coh_xhci_irq_quiesced_active ${coh_xhci_irq_quiesced}; echo "[cohesix] xhci-irq-quiesced active=${coh_xhci_irq_quiesced}"; else setenv coh_xhci_irq_quiesced_active absent; echo "[cohesix] xhci-irq-quiesced active=absent"; fi; if env exists coh_xhci_halted; then setenv coh_xhci_halted_active ${coh_xhci_halted}; echo "[cohesix] xhci-handoff-halted active=${coh_xhci_halted}"; else setenv coh_xhci_halted_active absent; echo "[cohesix] xhci-handoff-halted active=absent"; fi; if env exists coh_xhci_handoff_safe; then setenv coh_xhci_handoff_safe_active ${coh_xhci_handoff_safe}; echo "[cohesix] xhci-handoff-safe active=${coh_xhci_handoff_safe}"; else setenv coh_xhci_handoff_safe_active absent; echo "[cohesix] xhci-handoff-safe active=absent"; fi; echo "[cohesix] xhci-reprobe-result reset=${coh_xhci_reprobe_result} ready=${coh_xhci_handoff_ready_active} irq=${coh_xhci_irq_quiesced_active} halted=${coh_xhci_halted_active} safe=${coh_xhci_handoff_safe_active} input=${coh_usb_input_ready}"'
setenv coh_capture_xhci_handoff_snapshot 'if env exists coh_xhci_handoff_ready && test "${coh_xhci_handoff_ready}" = "1"; then setenv coh_xhci_handoff_ready_saved 1; echo "[cohesix] xhci-handoff-ready pre-stop=1"; else setenv coh_xhci_handoff_ready_saved 0; echo "[cohesix] xhci-handoff-ready pre-stop=0"; fi; if env exists coh_xhci_irq_quiesced && test "${coh_xhci_irq_quiesced}" = "1"; then setenv coh_xhci_irq_quiesced_saved 1; echo "[cohesix] xhci-irq-quiesced pre-stop=1"; else setenv coh_xhci_irq_quiesced_saved 0; echo "[cohesix] xhci-irq-quiesced pre-stop=0"; fi; if env exists coh_xhci_halted && test "${coh_xhci_halted}" = "1"; then setenv coh_xhci_halted_saved 1; echo "[cohesix] xhci-handoff-halted pre-stop=1"; else setenv coh_xhci_halted_saved 0; echo "[cohesix] xhci-handoff-halted pre-stop=0"; fi; if env exists coh_xhci_handoff_safe && test "${coh_xhci_handoff_safe}" = "1"; then setenv coh_xhci_handoff_safe_saved 1; echo "[cohesix] xhci-handoff-safe pre-stop=1"; else setenv coh_xhci_handoff_safe_saved 0; echo "[cohesix] xhci-handoff-safe pre-stop=0"; fi'
setenv coh_clear_xhci_handoff_live 'setenv coh_xhci_handoff_ready; setenv coh_xhci_irq_quiesced; setenv coh_xhci_halted; setenv coh_xhci_handoff_safe; setenv coh_xhci_usbcmd; setenv coh_xhci_usbsts; setenv coh_xhci_iman0; setenv coh_xhci_dcbaap; setenv coh_xhci_crcr; setenv coh_xhci_erstba0; setenv coh_xhci_erdp0; setenv coh_xhci_erstsz0; echo "[cohesix] xhci handoff live tokens cleared before usb stop"'
setenv coh_finalize_xhci_handoff 'if env exists coh_xhci_handoff_ready && test "${coh_xhci_handoff_ready}" = "1"; then setenv coh_xhci_handoff_ready_post 1; else setenv coh_xhci_handoff_ready_post 0; fi; if env exists coh_xhci_irq_quiesced && test "${coh_xhci_irq_quiesced}" = "1"; then setenv coh_xhci_irq_quiesced_post 1; else setenv coh_xhci_irq_quiesced_post 0; fi; if env exists coh_xhci_halted && test "${coh_xhci_halted}" = "1"; then setenv coh_xhci_halted_post 1; else setenv coh_xhci_halted_post 0; fi; if env exists coh_xhci_handoff_safe && test "${coh_xhci_handoff_safe}" = "1"; then setenv coh_xhci_handoff_safe_post 1; else setenv coh_xhci_handoff_safe_post 0; fi; if test "${coh_xhci_handoff_capture_mode}" = "reprobe"; then setenv coh_xhci_handoff_source_prefix reprobe; else setenv coh_xhci_handoff_source_prefix runtime; fi; if test "${coh_xhci_handoff_ready_post}" = "1" && test "${coh_xhci_irq_quiesced_post}" = "1" && test "${coh_xhci_halted_post}" = "1" && test "${coh_xhci_handoff_safe_post}" = "1"; then setenv coh_xhci_handoff_ready 1; setenv coh_xhci_irq_quiesced 1; setenv coh_xhci_halted 1; setenv coh_xhci_handoff_safe 1; setenv coh_xhci_handoff_source ${coh_xhci_handoff_source_prefix}-post-stop-safe; echo "[cohesix] xhci handoff contract exported after usb stop"; else setenv coh_xhci_handoff_ready; setenv coh_xhci_irq_quiesced; setenv coh_xhci_halted; setenv coh_xhci_handoff_safe; if test "${coh_xhci_handoff_ready_post}" = "1" || test "${coh_xhci_irq_quiesced_post}" = "1" || test "${coh_xhci_halted_post}" = "1" || test "${coh_xhci_handoff_safe_post}" = "1" || test "${coh_xhci_handoff_ready_saved}" = "1" || test "${coh_xhci_irq_quiesced_saved}" = "1" || test "${coh_xhci_halted_saved}" = "1" || test "${coh_xhci_handoff_safe_saved}" = "1"; then setenv coh_xhci_handoff_source ${coh_xhci_handoff_source_prefix}-partial; else setenv coh_xhci_handoff_source ${coh_xhci_handoff_source_prefix}-absent; fi; fi; echo "[cohesix] xhci-handoff-ready post-stop=${coh_xhci_handoff_ready_post}"; echo "[cohesix] xhci-irq-quiesced post-stop=${coh_xhci_irq_quiesced_post}"; echo "[cohesix] xhci-handoff-halted post-stop=${coh_xhci_halted_post}"; echo "[cohesix] xhci-handoff-safe post-stop=${coh_xhci_handoff_safe_post}"; if env exists coh_xhci_handoff_ready; then echo "[cohesix] xhci-handoff-ready=${coh_xhci_handoff_ready} final"; else echo "[cohesix] xhci-handoff-ready=absent final"; fi; if env exists coh_xhci_irq_quiesced; then echo "[cohesix] xhci-irq-quiesced=${coh_xhci_irq_quiesced} final"; else echo "[cohesix] xhci-irq-quiesced=absent final"; fi; if env exists coh_xhci_halted; then echo "[cohesix] xhci-handoff-halted=${coh_xhci_halted} final"; else echo "[cohesix] xhci-handoff-halted=absent final"; fi; if env exists coh_xhci_handoff_safe; then echo "[cohesix] xhci-handoff-safe=${coh_xhci_handoff_safe} final"; else echo "[cohesix] xhci-handoff-safe=absent final"; fi; if env exists coh_xhci_handoff_ready && env exists coh_xhci_irq_quiesced && env exists coh_xhci_halted && env exists coh_xhci_handoff_safe; then echo "[cohesix] xhci-handoff-contract state=safe action=mirror source=${coh_xhci_handoff_source}"; elif test "${coh_xhci_handoff_source}" = "${coh_xhci_handoff_source_prefix}-partial"; then echo "[cohesix] xhci-handoff-contract state=partial action=reject source=${coh_xhci_handoff_source}"; else echo "[cohesix] xhci-handoff-contract state=absent action=reject source=${coh_xhci_handoff_source}"; fi'
setenv coh_quiesce_usb 'setenv stdin serial; setenv coh_xhci_handoff_capture_mode reprobe; setenv coh_xhci_handoff_source reprobe-absent; setenv coh_xhci_handoff_ready_post 0; setenv coh_xhci_irq_quiesced_post 0; setenv coh_xhci_halted_post 0; setenv coh_xhci_handoff_safe_post 0; if env exists coh_xhci_handoff_ready; then echo "[cohesix] xhci-handoff-ready pre-reprobe=${coh_xhci_handoff_ready}"; else echo "[cohesix] xhci-handoff-ready pre-reprobe=absent"; fi; if env exists coh_xhci_irq_quiesced; then echo "[cohesix] xhci-irq-quiesced pre-reprobe=${coh_xhci_irq_quiesced}"; else echo "[cohesix] xhci-irq-quiesced pre-reprobe=absent"; fi; if env exists coh_xhci_halted; then echo "[cohesix] xhci-handoff-halted pre-reprobe=${coh_xhci_halted}"; else echo "[cohesix] xhci-handoff-halted pre-reprobe=absent"; fi; if env exists coh_xhci_handoff_safe; then echo "[cohesix] xhci-handoff-safe pre-reprobe=${coh_xhci_handoff_safe}"; else echo "[cohesix] xhci-handoff-safe pre-reprobe=absent"; fi; run coh_force_xhci_handoff_reprobe; run coh_capture_xhci_handoff_snapshot; run coh_clear_xhci_handoff_live; if usb stop; then echo "[cohesix] USB host quiesced before handoff"; run coh_finalize_xhci_handoff; else setenv coh_xhci_handoff_ready; setenv coh_xhci_irq_quiesced; setenv coh_xhci_halted; setenv coh_xhci_handoff_safe; setenv coh_xhci_usbcmd; setenv coh_xhci_usbsts; setenv coh_xhci_iman0; setenv coh_xhci_dcbaap; setenv coh_xhci_crcr; setenv coh_xhci_erstba0; setenv coh_xhci_erdp0; setenv coh_xhci_erstsz0; setenv coh_xhci_handoff_ready_post 0; setenv coh_xhci_irq_quiesced_post 0; setenv coh_xhci_halted_post 0; setenv coh_xhci_handoff_safe_post 0; setenv coh_xhci_handoff_source reprobe-usb-stop-failed; echo "[cohesix] WARNING: usb stop failed before handoff"; echo "[cohesix] xhci-handoff-contract state=absent action=reject source=reprobe-usb-stop-failed"; fi'
setenv coh_apply_xhci_cap_snapshot 'if test "${coh_boot_error}" != "1" && env exists coh_xhci_cap_length; then if fdt set /chosen cohesix,xhci-cap-length "${coh_xhci_cap_length}"; then echo "[cohesix] dtb chosen cohesix,xhci-cap-length=${coh_xhci_cap_length}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-cap-length"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_hci_version; then if fdt set /chosen cohesix,xhci-hci-version "${coh_xhci_hci_version}"; then echo "[cohesix] dtb chosen cohesix,xhci-hci-version=${coh_xhci_hci_version}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-hci-version"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_hcs1; then if fdt set /chosen cohesix,xhci-hcs1 "${coh_xhci_hcs1}"; then echo "[cohesix] dtb chosen cohesix,xhci-hcs1=${coh_xhci_hcs1}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-hcs1"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_hcs2; then if fdt set /chosen cohesix,xhci-hcs2 "${coh_xhci_hcs2}"; then echo "[cohesix] dtb chosen cohesix,xhci-hcs2=${coh_xhci_hcs2}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-hcs2"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_hccparams1; then if fdt set /chosen cohesix,xhci-hccparams1 "${coh_xhci_hccparams1}"; then echo "[cohesix] dtb chosen cohesix,xhci-hccparams1=${coh_xhci_hccparams1}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-hccparams1"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_dboff; then if fdt set /chosen cohesix,xhci-dboff "${coh_xhci_dboff}"; then echo "[cohesix] dtb chosen cohesix,xhci-dboff=${coh_xhci_dboff}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-dboff"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_rtsoff; then if fdt set /chosen cohesix,xhci-rtsoff "${coh_xhci_rtsoff}"; then echo "[cohesix] dtb chosen cohesix,xhci-rtsoff=${coh_xhci_rtsoff}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-rtsoff"; setenv coh_boot_error 1; fi; fi'
...
setenv coh_apply_dtb_policy 'if test "${coh_boot_error}" = "1"; then true; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_mmio_raw && env exists coh_xhci_mmio; then echo "[cohesix] xhci-mmio raw=${coh_xhci_mmio_raw} phys=${coh_xhci_mmio}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_pci_cmd; then echo "[cohesix] xhci-pci-cmd=${coh_xhci_pci_cmd}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_usbcmd; then echo "[cohesix] xhci-usbcmd=${coh_xhci_usbcmd}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_usbsts; then echo "[cohesix] xhci-usbsts=${coh_xhci_usbsts}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_iman0; then echo "[cohesix] xhci-iman0=${coh_xhci_iman0}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_dcbaap; then echo "[cohesix] xhci-dcbaap=${coh_xhci_dcbaap}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_crcr; then echo "[cohesix] xhci-crcr=${coh_xhci_crcr}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_erstba0; then echo "[cohesix] xhci-erstba0=${coh_xhci_erstba0}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_erdp0; then echo "[cohesix] xhci-erdp0=${coh_xhci_erdp0}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_erstsz0; then echo "[cohesix] xhci-erstsz0=${coh_xhci_erstsz0}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_handoff_ready; then echo "[cohesix] xhci-handoff-ready=${coh_xhci_handoff_ready}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_irq_quiesced; then echo "[cohesix] xhci-irq-quiesced=${coh_xhci_irq_quiesced}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_halted; then echo "[cohesix] xhci-handoff-halted=${coh_xhci_halted}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_handoff_safe; then echo "[cohesix] xhci-handoff-safe=${coh_xhci_handoff_safe}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_handoff_source; then echo "[cohesix] xhci-handoff-source=${coh_xhci_handoff_source}"; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_mmio; then if fdt set /chosen cohesix,xhci-mmio "${coh_xhci_mmio}"; then echo "[cohesix] dtb chosen cohesix,xhci-mmio=${coh_xhci_mmio}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-mmio"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_pci_cmd; then if fdt set /chosen cohesix,xhci-pci-cmd "${coh_xhci_pci_cmd}"; then echo "[cohesix] dtb chosen cohesix,xhci-pci-cmd=${coh_xhci_pci_cmd}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-pci-cmd"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_usbcmd; then if fdt set /chosen cohesix,xhci-usbcmd "${coh_xhci_usbcmd}"; then echo "[cohesix] dtb chosen cohesix,xhci-usbcmd=${coh_xhci_usbcmd}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-usbcmd"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_usbsts; then if fdt set /chosen cohesix,xhci-usbsts "${coh_xhci_usbsts}"; then echo "[cohesix] dtb chosen cohesix,xhci-usbsts=${coh_xhci_usbsts}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-usbsts"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_iman0; then if fdt set /chosen cohesix,xhci-iman0 "${coh_xhci_iman0}"; then echo "[cohesix] dtb chosen cohesix,xhci-iman0=${coh_xhci_iman0}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-iman0"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_dcbaap; then if fdt set /chosen cohesix,xhci-dcbaap "${coh_xhci_dcbaap}"; then echo "[cohesix] dtb chosen cohesix,xhci-dcbaap=${coh_xhci_dcbaap}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-dcbaap"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_crcr; then if fdt set /chosen cohesix,xhci-crcr "${coh_xhci_crcr}"; then echo "[cohesix] dtb chosen cohesix,xhci-crcr=${coh_xhci_crcr}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-crcr"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_erstba0; then if fdt set /chosen cohesix,xhci-erstba0 "${coh_xhci_erstba0}"; then echo "[cohesix] dtb chosen cohesix,xhci-erstba0=${coh_xhci_erstba0}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-erstba0"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_erdp0; then if fdt set /chosen cohesix,xhci-erdp0 "${coh_xhci_erdp0}"; then echo "[cohesix] dtb chosen cohesix,xhci-erdp0=${coh_xhci_erdp0}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-erdp0"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_erstsz0; then if fdt set /chosen cohesix,xhci-erstsz0 "${coh_xhci_erstsz0}"; then echo "[cohesix] dtb chosen cohesix,xhci-erstsz0=${coh_xhci_erstsz0}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-erstsz0"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_handoff_ready; then if fdt set /chosen cohesix,xhci-handoff-ready "${coh_xhci_handoff_ready}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-ready=${coh_xhci_handoff_ready}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-ready"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_irq_quiesced; then if fdt set /chosen cohesix,xhci-irq-quiesced "${coh_xhci_irq_quiesced}"; then echo "[cohesix] dtb chosen cohesix,xhci-irq-quiesced=${coh_xhci_irq_quiesced}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-irq-quiesced"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_halted; then if fdt set /chosen cohesix,xhci-handoff-halted "${coh_xhci_halted}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-halted=${coh_xhci_halted}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-halted"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_handoff_safe; then if fdt set /chosen cohesix,xhci-handoff-safe "${coh_xhci_handoff_safe}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-safe=${coh_xhci_handoff_safe}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-safe"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && env exists coh_xhci_handoff_source; then if fdt set /chosen cohesix,xhci-handoff-source "${coh_xhci_handoff_source}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-source=${coh_xhci_handoff_source}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-source"; setenv coh_boot_error 1; fi; fi; run coh_apply_xhci_cap_snapshot; if test "${coh_boot_error}" != "1" && test -n "${coh_xhci_handoff_ready_saved}"; then if fdt set /chosen cohesix,xhci-handoff-prestop-ready "${coh_xhci_handoff_ready_saved}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-prestop-ready=${coh_xhci_handoff_ready_saved}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-prestop-ready"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_xhci_irq_quiesced_saved}"; then if fdt set /chosen cohesix,xhci-handoff-prestop-irq "${coh_xhci_irq_quiesced_saved}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-prestop-irq=${coh_xhci_irq_quiesced_saved}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-prestop-irq"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_xhci_halted_saved}"; then if fdt set /chosen cohesix,xhci-handoff-prestop-halted "${coh_xhci_halted_saved}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-prestop-halted=${coh_xhci_halted_saved}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-prestop-halted"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_xhci_handoff_safe_saved}"; then if fdt set /chosen cohesix,xhci-handoff-prestop-safe "${coh_xhci_handoff_safe_saved}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-prestop-safe=${coh_xhci_handoff_safe_saved}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-prestop-safe"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_xhci_handoff_ready_post}"; then if fdt set /chosen cohesix,xhci-handoff-poststop-ready "${coh_xhci_handoff_ready_post}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-poststop-ready=${coh_xhci_handoff_ready_post}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-poststop-ready"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_xhci_irq_quiesced_post}"; then if fdt set /chosen cohesix,xhci-handoff-poststop-irq "${coh_xhci_irq_quiesced_post}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-poststop-irq=${coh_xhci_irq_quiesced_post}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-poststop-irq"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_xhci_halted_post}"; then if fdt set /chosen cohesix,xhci-handoff-poststop-halted "${coh_xhci_halted_post}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-poststop-halted=${coh_xhci_halted_post}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-poststop-halted"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_xhci_handoff_safe_post}"; then if fdt set /chosen cohesix,xhci-handoff-poststop-safe "${coh_xhci_handoff_safe_post}"; then echo "[cohesix] dtb chosen cohesix,xhci-handoff-poststop-safe=${coh_xhci_handoff_safe_post}"; else echo "[cohesix] ERROR: failed to set cohesix,xhci-handoff-poststop-safe"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_net_mode}"; then if fdt set /chosen cohesix,net-mode "${coh_net_mode}"; then echo "[cohesix] dtb chosen cohesix,net-mode=${coh_net_mode}"; else echo "[cohesix] ERROR: failed to set cohesix,net-mode"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_net_interface}"; then if fdt set /chosen cohesix,net-interface "${coh_net_interface}"; then echo "[cohesix] dtb chosen cohesix,net-interface=${coh_net_interface}"; else echo "[cohesix] ERROR: failed to set cohesix,net-interface"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_static_ip}"; then if fdt set /chosen cohesix,static-ipv4 "${coh_static_ip}"; then echo "[cohesix] dtb chosen cohesix,static-ipv4=${coh_static_ip}"; else echo "[cohesix] ERROR: failed to set cohesix,static-ipv4"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_static_prefix_len}"; then if fdt set /chosen cohesix,static-prefix-len "${coh_static_prefix_len}"; then echo "[cohesix] dtb chosen cohesix,static-prefix-len=${coh_static_prefix_len}"; else echo "[cohesix] ERROR: failed to set cohesix,static-prefix-len"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_static_gateway}"; then if fdt set /chosen cohesix,static-gateway "${coh_static_gateway}"; then echo "[cohesix] dtb chosen cohesix,static-gateway=${coh_static_gateway}"; else echo "[cohesix] ERROR: failed to set cohesix,static-gateway"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_wifi_ssid}"; then if fdt set /chosen cohesix,wifi-ssid "${coh_wifi_ssid}"; then echo "[cohesix] dtb chosen cohesix,wifi-ssid=<set>"; else echo "[cohesix] ERROR: failed to set cohesix,wifi-ssid"; setenv coh_boot_error 1; fi; fi; if test "${coh_boot_error}" != "1" && test -n "${coh_wifi_psk}"; then if fdt set /chosen cohesix,wifi-psk "${coh_wifi_psk}"; then echo "[cohesix] dtb chosen cohesix,wifi-psk=<set>"; else echo "[cohesix] ERROR: failed to set cohesix,wifi-psk"; setenv coh_boot_error 1; fi; fi'
