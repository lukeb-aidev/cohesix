...
setenv coh_clear_xhci_handoff_live 'setenv coh_xhci_handoff_ready; setenv coh_xhci_irq_quiesced; setenv coh_xhci_halted; setenv coh_xhci_handoff_safe; setenv coh_xhci_usbcmd; setenv coh_xhci_usbsts; setenv coh_xhci_iman0; echo "[cohesix] xhci handoff live tokens cleared before usb stop"'
