...
def main() -> int:
    ...
    source_tokens = {
        ...
        "apps/pi4-driver-runtime/src/lib.rs": [
            ...
            "usb_oldgood_receipt_follows_exact_linked_runtime_transition_order",
            "usb_oldgood_receipt_restarts_candidates_without_cross_path_stitching",
            "usb_oldgood_receipt_survives_normal_rearm_but_endpoint_recovery_revokes",
            "usb_oldgood_receipt_lifecycle_reset_rebinds_and_torn_commit_fails_closed",
        ],
