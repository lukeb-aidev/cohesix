...
def fetch_license_text(name: str, version: str, license_id: str | None, source_url: str | None = None) -> str:
    ...
    if not text and source_url:
        ...
        if 'github.com' in source_url:
            api_url = source_url.rstrip('/').replace('github.com', 'api.github.com/repos') + '/license'
