...
pub fn render_defaults(manifest: &Manifest, manifest_hash: &str) -> CohesixPyDefaults {
    ...
    .ok();
    writeln!(contents, "    \"authority\": {{\"production\": {}, \"delegated_rest\": {}, \"identity_class\": \"gateway_enforced\", \"strict_queen_intents\": {}, \"legacy_queen_ctl\": {}, \"writer_epoch\": {}, \"writer_epoch_required\": {}, \"queen_intent_schema\": \"queen-intent/v1\", \"queen_intent_path\": \"/queen/intents/ctl\", \"queen_dedupe_path\": \"/proc/queen/dedupe\", \"queen_intent_max_bytes\": {}, \"queen_dedupe_entries\": {}}},", py_bool(manifest.authority.production), py_bool(manifest.authority.delegated_rest), py_bool(manifest.authority.strict_queen_intents), py_bool(manifest.authority.legacy_queen_ctl), manifest.authority.writer_epoch, py_bool(manifest.authority.writer_epoch_required), manifest.authority.queen_intent_max_bytes, manifest.authority.queen_dedupe_entries).ok();
